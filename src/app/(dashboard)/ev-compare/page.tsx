...
const sampleCarDatabase: EVSpec[] = [
  {
    ...
    specs: {
      ...
      features: "เบาะไฟฟ้า, หลังคากระจกพาโนรามา, ระบบเสียง Premium (14 ลำโพง), โหมดขับขี่ 4 แบบ",
      length: "4,720 มม.",
      width: "1,933 มม.",
      height: "1,441 มม.",
      wheelbase: "2,875 มม.",
  ...
  },
  {
    ...
    specs: {
      ...
      features: "เบาะหนัง Vegan, หลังคากระจก, ฝาท้ายไฟฟ้า, V2L 3.3kW, แอร์ PM2.5",
      length: "4,455 มม.",
      width: "1,875 มม.",
      height: "1,615 มม.",
      wheelbase: "2,720 มม.",
  ...
  },
  {
    ...
    specs: {
      ...
      features: "เบาะสปอร์ต, จอ 10.25 นิ้ว, ระบบเสียง 6 ลำโพง, แอร์ 2 โซน",
      length: "4,287 มม.",
      width: "1,836 มม.",
      height: "1,516 มม.",
      wheelbase: "2,705 มม.",
  ...
  },
  {
    ...
    specs: {
      ...
      features: "เบาะนวด, หลังคากระจกพาโนรามา, ระบบเสียง Burmester (15 ลำโพง), จอ Hyperscreen 55.5 นิ้ว, แอร์ 4 โซน",
      length: "4,859 มม.",
      width: "1,851 มม.",
      height: "1,428 มม.",
      wheelbase: "2,865 มม.",
  ...
  },
  {
    ...
    specs: {
      ...
      features: "เบาะไฟฟ้า M Sport, หลังคากระจก, ระบบเสียง Harman Kardon (18 ลำโพง), จอ Curved Display, ไฟ LED Matrix",
      length: "4,755 มม.",
      width: "2,005 มม.",
      height: "1,616 มม.",
      wheelbase: "2,950 มม.",
  ...
  },
  {
    ...
    specs: {
      ...
      features: "เบาะไฟฟ้า, หน้าจอ 12.8 นิ้ว, V2L 2.2kW, แอร์อัตโนมัติ, สีตัวถังปรับแต่งได้ (4 สี)",
      length: "4,010 มม.",
      width: "1,865 มม.",
      height: "1,655 มม.",
      wheelbase: "2,660 มม.",
...
const defaultSpecFields: SpecField[] = [
  ...
  { key: "features", label: "จุดเด่น (Features)", enabled: true },
