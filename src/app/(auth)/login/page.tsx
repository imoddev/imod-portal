    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">iMoD Portal</CardTitle>
          <CardDescription>
            Internal System สำหรับทีม Mod Media
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          {error === "AccessDenied" && (
            <div className="p-3 rounded-lg bg-red-50 border border-red-200 text-red-700 text-sm text-center">
              ⚠️ อีเมลของคุณยังไม่ได้รับอนุญาตให้เข้าใช้งาน
              <br />
          ...
          <p className="text-center text-sm text-muted-foreground">
            ระบบ Invite-only — ต้องได้รับอนุญาตจาก Admin ก่อน
          </p>
        </CardContent>
      </Card>
    </div>
